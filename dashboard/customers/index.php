...
<main class="h-full pb-16 overflow-y-auto">
	...
	<div class="w-full overflow-hidden rounded-lg shadow-xs">
		<div class="w-full overflow-x-auto">
			...
			$i = 1;
			$qry = $conn->query("SELECT *, concat(firstname,' ', lastname) as `name` from `customer_list` order by `name` asc LIMIT {$perPage} OFFSET {$offset}");
			...
			?>
				<tr class="text-gray-700 dark:text-gray-400">
					...
					<td class="px-4 py-3 <?=$enable_raffle_mode_class_phone;?>">
					...
					<td class="px-4 py-3">
						<div class="flex items-center space-x-4 text-sm">
							<a href="./?page=customers/manage_customer&id=<?= $row['id'] ?>">
								<button
...
<?php if ($page > 1){ ?>
            <a href='./?page=customers&pg=<?php echo $page-1 ?>'><li>
                <button
...
<?php } ?>
    ...
    <?php if ($page > 3){ ?>
        <a href="./?page=customers&pg=1"><li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple">1</button></li></a>
    <li class="dots">...</li>
    <?php } ?>

    <?php if ($page-2 > 0){ ?>
        <a href="./?page=customers&pg=<?php echo $page-2 ?>"><li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"><?php echo $page-2 ?></button></li></a>
    <?php } ?>

    <?php if ($page-1 > 0){ ?>
    <a href="./?page=customers&pg=<?php echo $page-1 ?>"><li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"><?php echo $page-1 ?></button></li></a>
  <?php } ?>

  <a href="./?page=customers&pg=<?php echo $page; ?>">
    <li>
...
<li class="dots">...</li>
<a href="./?page=customers&pg=<?php echo $totalPages ?>"><li><button class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple"><?php echo $totalPages ?></button></li></a>
<?php endif; ?>

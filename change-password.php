   ...
   <form autocomplete="off" id="form-change-password">
      <div class="alteracao-de-senha app-card card mb-2">
         <div class="card-body">
            ...
            <input type="password" name="password" class="form-control" id="password" autocomplete="off" placeholder="Digite sua senha" required="" minlength="5" maxlength="20">
            </div>
            <div class="">
            <label for="csenha" class="form-label">Confirmação de senha</label>
            <input type="password" name="rpassword" class="form-control" id="cpassword" placeholder="Confirme sua senha" required="" minlength="5" maxlength="20">
         </div>
         </div>
      </div>

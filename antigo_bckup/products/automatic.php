...
<?php if(!empty($draw_number)){ ?>
 ...
 <?php if (isset($cotapremiada) && $cotapremiada != ''): ?>
   ...
   <div class="app-card card">
      ...
      <div class="app_awarded_container justify-content-start">
         <div class="row px-3">
            ...
            if ($data_aw) {
               ...
               ?>                    
                     <div class="col px-1 mb-2 position-relative">
                        <div class="font-weight-200 text-center mb-2"><?php echo $linha['aw_label']; ?></div>
                        <button class="btn btn-success w-100 btn-sm p-0 text-nowrap font-xs xs:font-xss relative position-relative">
                           <?php if($aw_view) {?>
                           ...
                           <?php } ?>
                           <div class="py-1 px-2">
                                 <span class="font-weight-600"><?php if($aw_view) {?>❌<?php } else { ?>🏆<?php } ?><?php echo $linha['aw_number']; ?></span>   
                           </div>                                                
                        </button>
                     </div>
               <?php
      ...
      <span class="px-3" style="font-size: 0.75rem;"><?php echo isset($cotapremiada_descricao) ? $cotapremiada_descricao : ''; ?></span>
      </div>
   ...
   <div class="app-vendas-express mb-2">
      <div class="app-card card mb-2">
         <div class="card-body text-center">
            <p class="text-muted font-xs mb-3 pt-2">Selecione a quantidade de números</p>
            <div class="numeros-select d-flex align-items-center justify-content-center flex-column">
               <div class="vendasExpressNumsSelect">
                  <div onclick="qtyExpress(15, false);" class="item p-2 me-2 mb-2  flex-column ">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>15</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
                  <div onclick="qtyExpress(30, false);" class="item p-2 me-2 mb-2  flex-column mais-popular">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>30</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
                  <div onclick="qtyExpress(80, false);" class="item p-2 me-2 mb-2  flex-column ">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>80</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
                  <div onclick="qtyExpress(100, false);" class="item p-2 me-2 mb-2  flex-column">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>100</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
                  <div onclick="qtyExpress(200, false);" class="item p-2 me-2 mb-2  flex-column ">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>200</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
                  <div onclick="qtyExpress(300, false);" class="item p-2 me-2 mb-2  flex-column ">
                     <h3 class="mb-1"><small class="text-dark font-xsss">+</small>300</h3>
                     <p class="text-muted font-xss text-uppercase">Selecionar</p>
                  </div>
               </div>
               <div class="vendasExpressNums d-flex align-items-center">
                  ...
                  <div class="center">
                   <input class="form-control text-center qty" value="<?= isset($min_purchase) ? $min_purchase : "" ?>" aria-label="Quantidade de números" placeholder="<?= isset($min_purchase) ? $min_purchase : "" ?>"></div>
